...
function FAQSection() {
  return (
    <div className="top w-full bg-black flex flex-col items-center ">
      <h1 className="text-white text-[4rem] font-bold pt-7 text-center pb-5">
...
Kids profiles come with PIN-protected parental controls that let you restrict the maturity rating of content kids can watch and block specific titles you don’t want kids to see."
      ...
      <div>
        <h1 className="text-white mt-40 mb-4 text-[1.5rem]">
